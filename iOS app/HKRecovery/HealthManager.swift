...
class HealthManager {
  ...
  {
    // 1. Set the types we want to read from HK Store
    let healthKitTypesToRead = NSSet(array:[
      ...
      HKObjectType.workoutType(),HKObjectType.quantityTypeForIdentifier(HKQuantityTypeIdentifierActiveEnergyBurned),
    ...
    // 2. Set the types we want to write into HK Store
